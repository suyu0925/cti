...
using Zephyr.Utils.EPPlus.Table;
using System.Text.RegularExpressions;
using System.IO;
using System.Linq;
using Zephyr.Utils.EPPlus.DataValidation;
using Zephyr.Utils.EPPlus.DataValidation.Contracts;
using System.Reflection;
using Zephyr.Utils.EPPlus.Style.XmlAccess;
using System.Security;
using Zephyr.Utils.EPPlus.ConditionalFormatting;
using Zephyr.Utils.EPPlus.ConditionalFormatting.Contracts;
...
namespace Zephyr.Utils.EPPlus
{
	...
	public class ExcelRangeBase : ExcelAddress, IExcelCell, IDisposable, IEnumerable<ExcelRangeBase>, IEnumerator<ExcelRangeBase>
	{
		...
		private ExcelAddressBase GetAddressDim(ExcelRangeBase addr)
		{
			...
			if (addr._fromCol == fromRow && addr._fromCol == _fromCol && addr._toRow == toRow && addr._toCol == _toCol)
			{
				return addr;
			}
			else
