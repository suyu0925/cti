...
protected:
	...
	afx_msg void OnCHECKGtdu8FSKEnable();
	afx_msg void OnCHECKGtdu8GtdEnable();
	afx_msg void OnRadioGainModeNochange();
	afx_msg void OnRadioGainModeFix();
	afx_msg void OnRadioGainModeAls();
	afx_msg void OnRadioGainModeAgc();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
