...
#region DJAcsDataDef.h
    ...
    public struct Acs_VoIP_RTCPADDR
    {
        public ChAddr audio;
        public ChAddr video;
    };
    ...
    public struct Acs_VoIP_RTPDTMF
    {
	    ...
	    public DJ_U8	m_s8Volume;				/* volume (in dbm0 from -63 to 0) */
    ...
    public struct Acs_MediaEx_Input
    {
	    ...
	    public DJ_U32		m_u32ProfileLevelId;	/* codec extra attribute */
    };/*Acs_MediaEx_Input*/

    /* Acs MediaEx Output Param */
    public struct Acs_MediaEx_Output
    {
	    ...
	    public DJ_U8		m_u8MaxFps;				/* max fps */
    ...
    public struct CmdParamData_CAS_t
    {
	    ...
	    public fixed DJ_U8						m_u8Rfu[8];				/* Reserved for Future Use */
    };/*CmdParamData_CAS_t*/
