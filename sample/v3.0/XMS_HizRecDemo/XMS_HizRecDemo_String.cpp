...
char * GetString_EventType ( EventType_t EvtType )
{
	...
	case XMS_EVT_CTX_REG:		    return "CTXREG";
	case XMS_EVT_CTX_LINK:		    return "CTXLINK";
	case XMS_EVT_CTX_APPDATA:		return "CTXAPPDATA";
	case XMS_EVT_DRS_CALL_NUMS:		return "DRSCALLNUMS";
