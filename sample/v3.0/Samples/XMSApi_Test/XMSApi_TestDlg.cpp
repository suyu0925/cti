...
bool g_bIsExPathTo260 = 0;

extern char   g_szCSPRecordFile[MAX_PATH];
extern char   g_szCSPPlayFile[MAX_PATH];
extern ACSHandle_t		g_acsHandle;

DJ_S32 g_s32CSPPlayControlType = XMS_CSP_STOP_PLAY;
DJ_S32 g_s32CSPRecControlType = XMS_CSP_STOP_RECORD;
...
void CXMSApi_TestDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_COMBO_GetParamType, m_ComboGetParam);
	DDX_Control(pDX, IDC_CHECK_260_PATH, m_IsExPath);
...
BEGIN_MESSAGE_MAP(CXMSApi_TestDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_BUTTON_GetParam, OnBUTTONGetParam)
	ON_BN_CLICKED(IDC_BUTTON_TIMER, OnButtonTimer)
	ON_BN_CLICKED(IDC_BUTTON_Register, OnBUTTONRegister)
	ON_BN_CLICKED(IDC_BUTTON_SendSignalData, OnBUTTONSendSignalData)
	ON_BN_CLICKED(IDC_BUTTON_SendAppData, OnBUTTONSendAppData)
	ON_BN_CLICKED(IDC_BUTTON_SelectPlayFile2, OnBUTTONSelectPlayFile2)
	ON_CBN_SELCHANGE(IDC_COMBO_GetParamType, OnSelchangeCOMBOGetParamType)
	ON_BN_CLICKED(IDC_BUTTON_LED, OnButtonLed)
	ON_BN_CLICKED(IDC_BUTTON_Set_Master, OnBUTTONSetMaster)
	ON_BN_CLICKED(IDC_BUTTON_GET_RELATE_MOD, OnButtonGetRelateMod)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
BOOL CXMSApi_TestDlg::OnInitDialog()
{
	...
	((CButton *)GetDlgItem ( IDC_RADIO_CALLER_DTMF ))->SetCheck ( 0 );
	((CButton *)GetDlgItem ( IDC_RADIO_CALLER_FSK ))->SetCheck ( 1 );
	GetDlgItem ( IDC_RADIO_CALLER_DTMF )->EnableWindow( 0 );
	GetDlgItem ( IDC_RADIO_CALLER_FSK )->EnableWindow( 0 );
	

    ((CButton *)GetDlgItem ( IDC_CHECK_260_PATH ))->SetCheck(0);
    g_bIsExPathTo260 = 0;
	///////////////////////////////////////////////////////
...
void CXMSApi_TestDlg::OnBUTTONMyStopPlay() 
{
	...
	// TODO: Add your control notification handler code here
	CComboBox *pCB;
	pCB = (CComboBox *)this->GetDlgItem(IDC_COMBO_STOP_MEDIA_TYPE);
	if (NULL == pCB)
	{
		ASSERT(0);
		return;
...
{
	CSP_OPERATER* pCSP = NULL;
	
	memset(g_szCSPRecordFile, 0, MAX_PATH);

	
	pCSP = GetCurrVocCSPProperty( );
	if ( NULL != pCSP )
	{
		GetDlgItem ( IDC_EDIT_RECCSP_FILE )->GetWindowText ( g_szCSPRecordFile, MAX_PATH-1 );
		strcpy( pCSP->m_szCSPRecordFile, g_szCSPRecordFile );
...
void CXMSApi_TestDlg::OnButtonCtrlreccsp() 
{
	...
	DoFunc_CtrlRecCSP( g_s32CSPRecControlType );	
}
...
void CXMSApi_TestDlg::OnButtonPlaycsp() 
{
	...
	memset(g_szCSPPlayFile, 0, MAX_PATH );
	GetDlgItem ( IDC_EDIT_PLAYCSP_FILE )->GetWindowText ( g_szCSPPlayFile, MAX_PATH-1 );

	strcpy(pCSP->m_szCSPPlayFile, g_szCSPPlayFile);
...
void CXMSApi_TestDlg::OnButtonCtrlplaycsp() 
{
	...
	DoFunc_ControlPlayCSP( g_s32CSPPlayControlType );	
}
...
void CXMSApi_TestDlg::OnBUTTONStart324Session() 
{
	// TODO: Add your control notification handler code here
	DJ_U16      u16SignalMsgType = 1; //XMS_324_CMD_TYPE_NORMAL_START;

	DoFunc_SendSignalMsg(u16SignalMsgType);
}

void CXMSApi_TestDlg::OnBUTTONStart324Montor() 
{
	// TODO: Add your control notification handler code here
	DJ_U16      u16SignalMsgType = XMS_324_CMD_TYPE_MONITOR_START;
	DoFunc_SendSignalMsg(u16SignalMsgType);
}

void CXMSApi_TestDlg::OnBUTTON3GPPGetCfg() 
{
	// TODO: Add your control notification handler code here
	int iRet = 0;
	...
	DoFunc_3GPPGetConfig( );	
}

void CXMSApi_TestDlg::OnBUTTONGetParam() 
{
	// TODO: Add your control notification handler code here
	DoFunc_GetParam();
}

void CXMSApi_TestDlg::OnButtonTimer() 
{
	// TODO: Add your control notification handler code here
	// TODO: Add your control notification handler code here
	int iRet = 0;
...
void CXMSApi_TestDlg::OnBUTTONRegister() 
{
	DoFunc_CtxReg();		
}

void CXMSApi_TestDlg::OnBUTTONSendSignalData() 
{
	/*
	...
	DoFunc_SendSignalData();
}

void CXMSApi_TestDlg::OnBUTTONSendAppData() 
{
	DoFunc_CTXAppData();
}

void CXMSApi_TestDlg::OnBUTTONSelectPlayFile2() 
{
	SelectRecordFile(IDC_EDIT_PLAYCSP_FILE);			
}

void CXMSApi_TestDlg::OnSelchangeCOMBOGetParamType() 
{
	// TODO: Add your control notification handler code here
	iComboGetParam = m_ComboGetParam.GetCurSel ( ); 
}

void CXMSApi_TestDlg::OnButtonLed() 
{
	DoFunc_LedCtrl();
}

void CXMSApi_TestDlg::OnBUTTONSetMaster() 
{
	// TODO: Add your control notification handler code here
	DoFunc_SetMaster();
}

void CXMSApi_TestDlg::OnButtonGetRelateMod() 
{
	// TODO: Add your control notification handler code here
	DoFunc_GetRelateMod();
}
