...
BEGIN_MESSAGE_MAP(CXMSApi_Test_ParamVoice, CDialog)
	...
	ON_BN_CLICKED(IDC_CHECK_Gtd_u8FSKEnable, OnCHECKGtdu8FSKEnable)
	ON_BN_CLICKED(IDC_CHECK_Gtd_u8GTDEnable, OnCHECKGtdu8GtdEnable)
	ON_BN_CLICKED(IDC_RADIO_GAIN_MODE_NOCHANGE, OnRadioGainModeNochange)
	ON_BN_CLICKED(IDC_RADIO_GAIN_MODE_FIX, OnRadioGainModeFix)
	ON_BN_CLICKED(IDC_RADIO_GAIN_MODE_ALS, OnRadioGainModeAls)
	ON_BN_CLICKED(IDC_RADIO_GAIN_MODE_AGC, OnRadioGainModeAgc)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
BOOL CXMSApi_Test_ParamVoice::OnInitDialog() 
{
	...
	//g_Voice_Param . m_VocInputControl .m_u8NrEnable
	((CButton *)GetDlgItem ( IDC_CHECK_In_u8NrEnable ))->SetCheck(g_Voice_Param.m_VocInputControl.m_u8NrEnable); 

	// g_Voice_Param . m_VocInputControl .m_u16FixGain
	if ( 0 == g_Voice_Param.m_VocInputControl.m_u16FixGain )
		g_Voice_Param.m_VocInputControl.m_u16FixGain = 1024;
	...
	if ( 0 == g_Voice_Param.m_u16PlayFixGain )
		g_Voice_Param.m_u16PlayFixGain = 1024;

	sprintf ( TmpStr, "%d", g_Voice_Param.m_u16PlayFixGain );
	GetDlgItem ( IDC_EDIT_Play_u16FixGain )->SetWindowText ( TmpStr );

    ((CButton *)GetDlgItem ( IDC_RADIO_GAIN_MODE_NOCHANGE ))->SetCheck(true);

	// g_Voice_Param . m_VocOutputControl . m_u16FixGain
	if ( 0 == g_Voice_Param.m_VocOutputControl.m_u16FixGain )
		g_Voice_Param.m_VocOutputControl.m_u16FixGain = 1024;
	...
	//g_Voice_Param . m_VocGtdControl . m_u8MR2BEnable
	((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8MR2BEnable ))->SetCheck(g_Voice_Param.m_VocGtdControl.m_u8MR2BEnable); 

	//g_Voice_Param . m_VocGtdControl . m_u8FskEnable
	((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8FSKEnable ))->SetCheck(g_Voice_Param.m_VocGtdControl.m_u8FSKEnable); 
	...
	//g_Voice_Param . m_VocGtdControl . m_u8EXTEnable
	((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8MSKEnable ))->SetCheck(g_Voice_Param.m_VocGtdControl.m_u8EXTEnable&EXT_ENABLE_MSK); 

	//g_Voice_Param . m_VocGtdControl . m_u8EXTEnable
	((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8VSDEnable ))->SetCheck(g_Voice_Param.m_VocGtdControl.m_u8EXTEnable&EXT_ENABLE_VSD); 

	//g_Voice_Param . m_VocGtdControl . m_u8GTDID
	GetDlgItem ( IDC_EDIT_Gtd_u8GTDID )->SetWindowText ((char*)g_Voice_Param.m_VocGtdControl.m_u8GTDID);
...
void CXMSApi_Test_ParamVoice::OnOK() 
{
	...
	if ( 1 == ((CButton *)GetDlgItem ( IDC_RADIO_GAIN_MODE_NOCHANGE ))->GetCheck() )
        g_Voice_Param.m_u8PlayGainMode = XMS_PLAY_GAIN_MODE_NOCHANGE;
	if ( 1 == ((CButton *)GetDlgItem ( IDC_RADIO_GAIN_MODE_FIX ))->GetCheck() )
        g_Voice_Param.m_u8PlayGainMode = XMS_PLAY_GAIN_MODE_FIX;
	if ( 1 == ((CButton *)GetDlgItem ( IDC_RADIO_GAIN_MODE_ALS ))->GetCheck() )
        g_Voice_Param.m_u8PlayGainMode = XMS_PLAY_GAIN_MODE_ALS;
	if ( 1 == ((CButton *)GetDlgItem ( IDC_RADIO_GAIN_MODE_AGC ))->GetCheck() )
        g_Voice_Param.m_u8PlayGainMode = XMS_PLAY_GAIN_MODE_AGC;
	...
	// g_Voice_Param . m_VocInputControl .m_u8NrEnable
	g_Voice_Param.m_VocInputControl.m_u8NrEnable = ((CButton *)GetDlgItem ( IDC_CHECK_In_u8NrEnable ))->GetCheck(); 
	...
	//g_Voice_Param . m_VocGtdControl . m_u8MR2BEnable
	g_Voice_Param.m_VocGtdControl.m_u8MR2BEnable = ((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8MR2BEnable ))->GetCheck(); 

	//g_Voice_Param . m_VocGtdControl . m_u8GTDEnable
	g_Voice_Param.m_VocGtdControl.m_u8GTDEnable = ((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8GTDEnable ))->GetCheck(); 

	//g_Voice_Param . m_VocGtdControl . m_u8FskEnable
	g_Voice_Param.m_VocGtdControl.m_u8FSKEnable = ((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8FSKEnable ))->GetCheck(); 
	...
	if ( ((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8MSKEnable ))->GetCheck() )
	g_Voice_Param.m_VocGtdControl.m_u8EXTEnable |= EXT_ENABLE_MSK; 

	if ( ((CButton *)GetDlgItem ( IDC_CHECK_Gtd_u8VSDEnable ))->GetCheck() )
	g_Voice_Param.m_VocGtdControl.m_u8EXTEnable |= EXT_ENABLE_VSD; 
...
void CXMSApi_Test_ParamVoice::HandleEnableDisable()
{
	...
	GetDlgItem ( IDC_CHECK_In_u8NrEnable )->EnableWindow(bNow);
	GetDlgItem ( IDC_EDIT_In_u16FixGain )->EnableWindow(bNow);
		
	bNow = (((CButton *)GetDlgItem ( IDC_RADIO_GAIN_MODE_FIX ))->GetCheck()==1);
	...
	GetDlgItem ( IDC_CHECK_Gtd_u8FSKEnable )->EnableWindow(bNow && bNowSub);
	...
	GetDlgItem ( IDC_CHECK_Gtd_u8MSKEnable )->EnableWindow(bNow && bNowSub);
	GetDlgItem ( IDC_CHECK_Gtd_u8VSDEnable )->EnableWindow(bNow && bNowSub);
...
void CXMSApi_Test_ParamVoice::OnCHECKGtdu8FSKEnable() 
{
	// TODO: Add your control notification handler code here
	
}

void CXMSApi_Test_ParamVoice::OnCHECKGtdu8GtdEnable() 
{
	// TODO: Add your control notification handler code here
...
void CXMSApi_Test_ParamVoice::OnRadioGainModeNochange() 
{
	// TODO: Add your control notification handler code here
		HandleEnableDisable();
}

void CXMSApi_Test_ParamVoice::OnRadioGainModeFix() 
{
	// TODO: Add your control notification handler code here
		HandleEnableDisable();
}

void CXMSApi_Test_ParamVoice::OnRadioGainModeAls() 
{
	// TODO: Add your control notification handler code here
		HandleEnableDisable();
}

void CXMSApi_Test_ParamVoice::OnRadioGainModeAgc() 
{
	// TODO: Add your control notification handler code here
		HandleEnableDisable();
}
