...
protected:
	...
	afx_msg void OnBUTTONStart324Session();
	afx_msg void OnBUTTONStart324Montor();
	afx_msg void OnBUTTON3GPPGetCfg();
	afx_msg void OnBUTTONGetParam();
	afx_msg void OnButtonTimer();
	afx_msg void OnBUTTONRegister();
	afx_msg void OnBUTTONSendSignalData();
	afx_msg void OnBUTTONSendAppData();
	afx_msg void OnBUTTONSelectPlayFile2();
	afx_msg void OnSelchangeCOMBOGetParamType();
	afx_msg void OnButtonLed();
	afx_msg void OnBUTTONSetMaster();
	afx_msg void OnButtonGetRelateMod();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
