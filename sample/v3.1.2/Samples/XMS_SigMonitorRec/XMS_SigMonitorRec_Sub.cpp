...
#include "XMS_SigMonitorRec_Event.H"
#include "XMS_SigMonitorRec_String.H"
...
extern CXMS_SigMonitorRecApp theApp;
CXMS_SigMonitorRecDlg	*pdlg;

// var about XMS_SigMonitorRec.INI
char			cfg_IniName[MAX_FILE_NAME_LEN] = "";
char			cfg_IniShortName[] = "\\XMS_SigMonitorRec.INI";
...
// var in XMS_SigMonitorRec_Event.CPP
...
bool	InitSystem()
{
	...
	pdlg = (CXMS_SigMonitorRecDlg	*)theApp.m_pMainWnd;

	// Read From "XMS_SigMonitorRec.INI"
	ReadFromConfig();
