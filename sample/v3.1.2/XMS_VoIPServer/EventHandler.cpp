...
BOOL CDJXms::InitSystem(unsigned int nId, const char* strServerIP, const int strServerPort, const char* strUserName, const char* strPassword)
{
    ...
    ret = XMS_acsSetESR(g_acsHandle, (EsrFunc)EventHandler, NULL, TRUE);
...
// CDJXms::EventHandler-------------------------------------------------------------------------------------------
DJ_Void CDJXms::EventHandler(DJ_Void *u32EsrParam)
{
...
/*
CDJDevice::CDJDevice(const CDJDevice &pdevice)
{
    memset(&m_device, pdevice, sizeof(DeviceID_t));
}*/
