// XMS_SigMonitorRecDlg.h : header file
//
...
class CXMS_SigMonitorRecDlg : public CDialog
{
// Construction
public:
	CXMS_SigMonitorRecDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	//{{AFX_DATA(CXMS_SigMonitorRecDlg)
	...
	//{{AFX_VIRTUAL(CXMS_SigMonitorRecDlg)
	protected:
...
protected:
	...
	afx_msg void OnRADIOSameModule();
	afx_msg void OnRADIOMostFreeFist();
