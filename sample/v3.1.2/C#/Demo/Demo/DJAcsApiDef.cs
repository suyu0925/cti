...
namespace DJKeygoe
{
    ...
    public class DJAcsApiDef
    {
        ...
        [DllImport("DJAcsAPI.dll")]
        public unsafe static extern RetCode_t XMS_ctsSetLayout(ACSHandle_t acsHandle, DeviceID_t* device3GVConfID, void* layoutList, PrivateData_t* privateData);
        ...
        [DllImport("DJAcsAPI.dll")]
        public unsafe static extern RetCode_t XMS_ctsSetVisibleList(ACSHandle_t acsHandle, DeviceID_t* device3GVConfID, void* visableList, PrivateData_t* privateData);
