...
class CXMS_EmDemoDlg : public CDialog
{
// Construction
public:
	CXMS_EmDemoDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	//{{AFX_DATA(CXMS_EmDemoDlg)
